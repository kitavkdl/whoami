...
function fortuneFor(subject: string) {
...
function StudyPage() {
  ...
  const fortune = useMemo(() => (submitted ? fortuneFor(submitted) : null), [submitted]);
    ...
    <main className="relative min-h-screen overflow-hidden bg-[#0a0a0c] text-white">
      ...
      <div className="mx-auto flex min-h-screen max-w-5xl flex-col px-6 py-16 md:px-10 md:py-20">
        ...
        <section className="mt-16 md:mt-24">
          ...
          >
            오늘의 <em className="italic text-white/70">학점</em> 운세
          </motion.h1>
          <motion.p
            initial={{ opacity: 0, y: 16 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            과목 이름을 적어보세요. 별과 데이터, 그리고 약간의 미신이 오늘의 학점을 점쳐드립니다.
            결과는 자정까지 바뀌지 않습니다.
          </motion.p>
        </section>
        ...
        >
          ...
          >
            <span className="relative z-10">운세 보기</span>
          </button>
        </motion.form>
            ...
            >
              <div className="relative overflow-hidden rounded-3xl border border-white/10 bg-white/[0.03] p-8 backdrop-blur-2xl md:p-12">
                ...
                <p className="mt-6 text-[11px] text-white/40">
                  * 결과는 과목 이름과 오늘 날짜를 기반으로 결정되며, 자정까지 동일하게 유지됩니다.
                </p>
              </div>
            </motion.section>
          )}
